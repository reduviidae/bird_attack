...
food1 = Food.create(name: "Pizza", location_x: 3, location_y: 2)
food2 = Food.create(name: "Fries", location_x: 2, location_y: 3)
food3 = Food.create(name: "Cheese", location_x: 2, location_y: 3)
food4 = Food.create(name: "Fruit", location_x: 2, location_y: 2)
food5 = Food.create(name: "Soda", location_x: 3, location_y: 1)

doctor1 = Doctor.create(name: "Dr. Bob", location_x: 2, location_y: 1)
doctor2 = Doctor.create(name: "Dr. Dr.", location_x: 1, location_y: 1)
doctor3 = Doctor.create(name: "Dr. Pepper", location_x: 2, location_y: 3)
doctor4 = Doctor.create(name: "Dr. My Guy", location_x: 1, location_y: 3)
doctor5 = Doctor.create(name: "Dr. Duckmans", location_x: 1, location_y: 2)
