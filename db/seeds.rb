...
bird11 = Bird.create(species: "Duck", sickness: false, attack:10)
bird12 = Bird.create(species: "Pigeon", sickness: true, attack:40)
bird13 = Bird.create(species: "Chicken", sickness: false, attack:20)
bird14 = Bird.create(species: "Swan", sickness: true, attack:25)
bird15 = Bird.create(species: "Albatross", sickness: false, attack:40)
bird16 = Bird.create(species: "Seagull", sickness: true, attack:30)
bird17 = Bird.create(species: "Finch", sickness: false, attack:10)
bird18 = Bird.create(species: "Sparrow", sickness: true, attack:10)
bird19 = Bird.create(species: "Goose", sickness: false, attack:20)
bird20 = Bird.create(species: "Pigeon", sickness: true, attack:40)
